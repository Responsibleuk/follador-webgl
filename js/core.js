...
const anita_config = {
    ...
    main_menu: {
        ...
        'Experience': 'page-about.html',
        'History': 'page-about.html',
    ...
    socials: {
        'facebook' : {
            'url': 'https://www.facebook.com/folladorprosecco',
            'label': 'Fb.',
            'target': '_blank' // Add the target attribute here
        },
        'linkedin' : {
            'url': 'https://www.linkedin.com/company/follador-prosecco-dal-1769',
            'label': 'Li.',
            'target': '_blank' // Add the target attribute here
        },
        'instagram' : {
